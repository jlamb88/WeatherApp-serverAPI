...
function weatherSearch(loc) {
  ...
  fetch(fetchAPI)
    ...
    .then(function (data) {
      ...
      dailyForecast = dailyForecast.push(data.city.name);
      ...
      $("#city-date").append('<h3 id="city-loc">' + cityLoc + '</h3><img src="http://openweathermap.org/img/wn/' +
        nowIcon + '@2x.png" id="now-icon" alt="weather now icon"></br><today>' + todayDt + '</today>')
      $("#data").append(
